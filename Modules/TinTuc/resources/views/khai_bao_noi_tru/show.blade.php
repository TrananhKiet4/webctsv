    ...
    <div class="col-lg-8">
        ...
        <div class="text-center mb-4">
            <span class="badge bg-primary rounded-pill px-4 py-2 mb-3">
                <i class="fas fa-building me-1"></i>Thông tin khai báo nội trú
            </span>
        ...
        <div class="card border-0 shadow-lg rounded-3 overflow-hidden">
            ...
            <div class="card-body p-4">
                <table class="table table-borderless mb-0">
                    ...
                    <tr class="border-top">
                        <td class="text-muted fw-medium ps-0">
                            <i class="fas fa-clock me-2 text-muted"></i>Ngày tạo:
                        </td>
                        <td class="text-muted small">{{ $khaiBao->created_at->format('d/m/Y H:i:s') }}</td>
                    </tr>
                </table>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        @if($khaiBao->trang_thai == 1)
                            <a href="{{ route('khai_bao_noi_tru.duyet', $khaiBao->id) }}" class="btn btn-success rounded-pill px-4">
                                <i class="fas fa-check me-1"></i> Duyệt
                            </a>
                            <a href="{{ route('khai_bao_noi_tru.tuChoi', $khaiBao->id) }}" class="btn btn-danger rounded-pill px-4">
                                <i class="fas fa-times me-1"></i> Từ chối
                            </a>
                        @endif
                        <a href="{{ route('khai_bao_noi_tru.edit', $khaiBao->id) }}" class="btn btn-warning text-dark rounded-pill px-4">
