...
@section('title', 'Chỉnh sửa khai báo ngoại trú')
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-lg rounded-3">
            <div class="card-header bg-warning text-dark border-0 py-4">
                <h4 class="mb-0 fw-bold"><i class="fas fa-edit me-2"></i>Chỉnh sửa Khai báo Ngoại trú</h4>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('khai_bao_ngoai_tru.update', $khaiBao->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                ...
                                <label for="ghi_chu"><i class="fas fa-sticky-note me-2 text-muted"></i>Ghi chú</label>
                            </div>
                        </div>
                    </div>
