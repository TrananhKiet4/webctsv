...
@section('title', 'Tạo kỳ khai báo ngoại trú')
...
<nav aria-label="breadcrumb" class="mb-4">
    <ol class="breadcrumb bg-white shadow-sm rounded-3 px-3 py-2 mb-0">
        ...
        <li class="breadcrumb-item active text-dark fw-medium" aria-current="page">Tạo kỳ khai báo</li>
    </ol>
</nav>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-lg rounded-3">
            <div class="card-header bg-gradient text-white border-0 py-4">
                <h4 class="mb-0 fw-bold"><i class="fas fa-calendar-plus me-2"></i>Tạo kỳ khai báo ngoại trú</h4>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('khai_bao_ngoai_tru.ky_store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="datetime-local" name="khai_bao_start_at" 
                                   ...
                                   id="khai_bao_start_at" value="{{ old('khai_bao_start_at') }}" required>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="datetime-local" name="khai_bao_end_at" 
                                   ...
                                   id="khai_bao_end_at" value="{{ old('khai_bao_end_at') }}" required>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-5">
                            <i class="fas fa-save me-1"></i> Tạo kỳ khai báo
                        </button>
                    </div>
                </form>
            </div>
